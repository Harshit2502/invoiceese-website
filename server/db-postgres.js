...
const initializeDatabase = async () => {
  try {
    ...
    const migrations = ['000_create_users_table.sql', '001_create_conversations_table.sql', '002_add_missing_fields.sql', '003_add_client_fields.sql', '004_add_gst_invoice_fields.sql', '005_add_inventory_and_purchases.sql', '006_widen_state_code_columns.sql'];
