...
router.post('/signup', async (req, res) => {
  try {
    ...
    const existing = db.users.find(u => u.email === normalizedEmail || normalizeWhatsAppNumber(u.whatsapp) === normalizedWhatsApp);
...
router.post('/login', async (req, res) => {
  try {
    ...
    const user = db.users.find(u => u.email === normalizedLogin || normalizeWhatsAppNumber(u.whatsapp) === normalizedWhatsApp);
