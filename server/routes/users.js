...
router.patch('/profile', async (req, res) => {
  ...
  const allowed = ['businessName', 'gstNumber', 'panNumber', 'address', 'city', 'pincode', 'state', 'stateCode', 'bankName', 'accountNumber', 'ifscCode', 'upiId', 'whatsapp', 'logoUrl', 'templateStyle', 'showWatermark', 'defaultDueDays', 'defaultRemindOnDays', 'defaultReminderChannels'];
