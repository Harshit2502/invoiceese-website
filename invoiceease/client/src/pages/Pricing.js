...
const plans = [
  {
    ...
    features: ['5 invoices per month', 'WhatsApp invoicing', 'GST compliant', 'Basic template', '7-day storage'],
    notIncluded: ['Custom logo', 'Remove watermark', 'Payment tracking'],
  ...
  },
  {
    ...
    featured: true,
    features: ['Unlimited invoices', 'WhatsApp invoicing', 'GST compliant', '3 premium templates', 'Lifetime storage', 'Custom logo upload', 'Remove watermark', 'Payment tracking', 'Priority support'],
    notIncluded: [],
...
const comparison = [
  { feature: 'Invoices per month', free: '5', pro: 'Unlimited', business: 'Unlimited' },
  { feature: 'WhatsApp invoicing', free: true, pro: true, business: true },
  { feature: 'GST compliant', free: true, pro: true, business: true },
  { feature: 'Hindi/Regional languages', free: true, pro: true, business: true },
  { feature: 'Invoice templates', free: '1 basic', pro: '3 premium', business: 'All' },
  { feature: 'Storage', free: '7 days', pro: 'Lifetime', business: 'Lifetime' },
  { feature: 'Custom logo', free: false, pro: true, business: true },
  ...
  { feature: 'Support', free: 'Email', pro: 'Priority email', business: 'Dedicated' },
];
...
const faqs = [
  ...
  { q: 'What happens if I exceed my free plan limit?', a: 'When you reach 5 invoices on the Free plan, you\'ll be prompted to upgrade. Your limit resets at the start of each month.' },
];
